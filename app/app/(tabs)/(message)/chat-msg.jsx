...
const InteractiveChat = () => {
  ...
  const [messages, setMessages] = useState([
    { id: 1, type: 'received', content: 'Did you attempt transaction on debit card ending in 0000 at Merchant in NJ for $1,200? Reply YES or NO' },
    { id: 2, type: 'sent', content: 'Yes' },
    { id: 3, type: 'received', content: "Bank of America : 206448 is your authorization code which expires in 10 minutes. If you didn't request the code. Call : 18009898 for assistance"}
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Bank of America</Text>
        </View>
