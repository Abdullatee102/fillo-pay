...
export default function Report() {
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'rgb(71, 71, 129)' }}>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 24, fontWeight: 'bold', margin: 20 }}>Report</Text>
            <Text style={{ fontSize: 16, color: 'gray', marginHorizontal: 20 }}>No Report has been added yet.</Text>
            ...
            <Pressable 
              ...
              onPress={() => Alert.alert('Add Report', 'This feature is coming soon!')}
            >
              <Text style={{ color: 'white', fontSize: 16, fontWeight: 'bold' }}>Add Report</Text>
            </Pressable>
          </View>
        </SafeAreaView>
      );
